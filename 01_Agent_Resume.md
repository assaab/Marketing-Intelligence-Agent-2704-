...
| Latest recorded verification snapshot | `156 passed, 2 skipped` |
| Public production evidence | API docs: `https://marcopsbackedncontainerapp.kindplant-7510bd3c.westeurope.azurecontainerapps.io/docs`; Frontend: `https://maropsfrontendconatinerapp.kindplant-7510bd3c.westeurope.azurecontainerapps.io/` |
...
| Public production UI evidence | Live frontend at `https://maropsfrontendconatinerapp.kindplant-7510bd3c.westeurope.azurecontainerapps.io/` |
...
- Benchmark scripts and smoke scripts are available in `scripts/benchmark_report.py` and `scripts/benchmark_smoke.py` for fresh capture
...
## Document revision
- April 2026, aligned to the `submission` package `v1.1-decision-engine`.
