...
## Latest Database-Verified Benchmark Snapshot (2026-04-07)

Source query basis: `public.workflow_runs`, `public.reports`, `public.recommendations` for campaign ids `9100001` to `9100005`.

| Campaign id | Latest analyze status | Duration (seconds) | Health | ROAS | CAC | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| `9100001` | success | `83.25` | warning | `0.48` | `266.21` | Cutback + refine + creative refresh recommendations |
| `9100002` | success | `82.31` | healthy | `2.33` | `32.22` | Scale winner + refine + creative refresh recommendations |
| `9100003` | success | `81.17` | healthy | `6.553` | `20.0` | Strong winner profile with scale recommendation |
| `9100004` | success | `82.08` | warning | `0.883` | `193.02` | Efficiency pressure profile with cutback recommendation |
| `9100005` | no successful analyze run found | `n/a` | `n/a` | `n/a` | `n/a` | Inserted in catalog, but no successful `analyze_campaign` row yet |

Aggregate benchmark across successful runs (`n=4`):
- Mean: `82.2s`
- P50: `82.19s`
- P95: `82.31s`
- Max: `83.25s`
- Under `1.5 minutes`: `true` for all successful runs
